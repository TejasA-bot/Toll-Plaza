...
class local {
    int a = 0, b = 0, c = 0, d = 0, Bike = 10, Car = 20, Bus = 25, Truck = 35, n = 0, amt = 0, tt = 0,
    		local = 0, outside = 0, tb = 0, tc = 0, ts = 0, tr = 0, op = 0;
    Scanner sc = new Scanner(System.in);

    public void loc_vechical() {
        System.out.println("\n\t No charges for local vechical");
        local = local + 1;
    }
}

class outside extends local {
    public void outs() throws InterruptedException {
